...
class _SettingsScreenState extends State<SettingsScreen> {
                    ...
                    : SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Danger Zone
                          _buildSectionTitle('Danger Zone', isDarkMode, isWarning: true),
                          _buildDeleteAccountButton(isDarkMode),
  ...
  Widget _buildSectionTitle(String title, bool isDarkMode, {bool isWarning = false}) {
    return Padding(
  ...
  Widget _buildDeleteAccountButton(bool isDarkMode) {
    return Container(
      margin: const EdgeInsets.symmetric(horizontal: 16),
      decoration: BoxDecoration(
